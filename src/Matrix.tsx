...
const RAINDROP_SPAWN_RATE = 0.5;

const GRADIENT = ["#51087E", "#5A0F8C", "#64179A", "#6D1EA8", "#7725B6"];
const WHITE = "#f0fdf4";

type Gradient = (typeof GRADIENT)[number];

type Color = typeof WHITE | Gradient;
...
export function MatrixRain() {
    ...
    if (matrixCanvasRef.current) {
      ...
      if (context) {
        ...
        const updateAndRender = () => {
          ...
          animationFrameId = requestAnimationFrame(updateAndRender); // Request next animation frame
        };

        animationFrameId = requestAnimationFrame(updateAndRender); // Start the animation loop
  ...
  function getRandomGreen(): Gradient {
    return getRandomFromArray(GRADIENT);
  }
